...
a.box:hover, a.box:focus {
  box-shadow: 0 2px 3px rgba(10, 10, 10, 0.1), 0 0 0 1px #00BCD4; }
a.box:active {
  box-shadow: inset 0 1px 2px rgba(10, 10, 10, 0.2), 0 0 0 1px #00BCD4; }
...
.button {
  ...
  .button:focus, .button.is-focused {
    border-color: #00BCD4;
    box-shadow: 0 0 0.5em rgba(0, 188, 212, 0.25);
    color: #363636; }
...
.hero {
  ...
  .hero.is-primary {
    ...
    .hero.is-primary.is-bold {
      background-image: linear-gradient(141deg, #00a198 0%, #00BCD4 71%, #00abee 100%); }
      @media screen and (max-width: 768px) {
...
/*# sourceMappingURL=mybulma.css.map */
