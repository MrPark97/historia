...
<body>
	...
	<article>
		<section class="hero is-bold is-light title-hero">
			<div class="hero-body">
				<div class="container">
				  <h1 class="title">Военный Спасо-Преображенский собор (Ташкент) <span class="tag is-primary">архитектура</span></h1>
		...
		<div class="container">
		  ...
		  <section class="section">
		  	<div class="content main-content">
					<h3 class="title">Описание и история</h3>
