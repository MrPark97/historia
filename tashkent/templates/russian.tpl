...
<body>
	...
	<article>
		<section class="hero is-light is-bold">
			<div class="hero-body">
				<div class="container">
						<h1 class="title section-title"><img src="/static/img/tashkentrussian.gif" class="coat-of-arms"> <span class="pobeda">ТАШКЕНТЪ</span> <span class="tag is-dark is-medium">1965-1917</span></h1>
				</div>
			</div>
		</section>
