...
<body>
	...
	<article>
		<section class="hero is-danger is-bold">
			<div class="hero-body">
				<div class="container">
						<h1 class="title section-title"><img src="/static/img/tashkentsoviet.gif" class="coat-of-arms"> <span class="pobeda">ТАШКЕНТ</span> <span class="tag is-dark is-medium">1917-1991</span></h1>
				</div>
			</div>
		</section>
